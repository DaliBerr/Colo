    ...
    public  class TickControl: MonoBehaviour
    {
        ...
        void Update()
        {
            if (tickDriver != null)
            {
                ...
                if (Input.GetKeyDown(InputConfiguration.ControlCommand["NormalSpeed"])) // +
                {
                ...
                else if (Input.GetKeyDown(InputConfiguration.ControlCommand["FastSpeed"])) // -
                {
                    controller.SetPreset(GameSpeed.Fast);
                    currentSpeed = GameSpeed.Fast;
                    // Events.eventBus.Publish(new SpeedChange(2f,currentSpeed));
                }
                else if (Input.GetKeyDown(InputConfiguration.ControlCommand["SuperFastSpeed"])) // ||
                {
                ...
                else if (Input.GetKeyDown(InputConfiguration.ControlCommand["Pause"]))
                {
                ...
                else if (Input.GetKeyDown(InputConfiguration.ControlCommand["StepOneTick"]))
                {
